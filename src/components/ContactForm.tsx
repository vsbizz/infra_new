...
function ContactForm() {
  ...
  return (
    <section className="py-10 sm:py-12 md:py-20 lg:py-24 bg-white border-t border-slate-100 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 lg:gap-16 items-start">
          <div>
            <h2 className="w-full max-w-none sm:max-w-none md:max-w-none text-[1.7rem] xs:text-[1.9rem] sm:text-4xl md:text-5xl md:font-bold text-slate-900 mb-4 sm:mb-5 md:mb-8 font-display leading-[1.08] tracking-tight">
              Contact Us about <br />
              <span className="text-teal-600 font-display">
                Healthcare Infrastructure and Asset Development Services
              </span>
            </h2>
            <p className="text-sm sm:text-[15px] md:text-lg lg:text-xl text-slate-600 mb-6 sm:mb-8 md:mb-10 lg:mb-12 leading-6 md:leading-relaxed max-w-md font-medium">
