  ...
  return (
    <div className="relative h-screen w-full overflow-hidden bg-white">
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-linear-to-r from-black/40 via-black/10 to-transparent z-1 pointer-events-none" />

        <div className="absolute inset-0 bg-linear-to-t from-black/30 via-transparent to-transparent z-1 pointer-events-none" />
      </div>
            ...
            return (
              <button
                ...
                className={`relative flex items-center gap-1 rounded-full p-1 transition-all duration-500 ease-in-out ${
                  isActive
                    ? "flex-2 bg-white/95 shadow-lg ring-1 ring-white/50 scale-[1.05] px-1"
                    : "flex-none opacity-60 hover:opacity-100 bg-transparent"
                }`}
              >
                {/* Thumbnail */}
                <img
