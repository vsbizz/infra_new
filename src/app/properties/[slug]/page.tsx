  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-16 md:pb-24">
      ...
      <div className="relative h-[50vh] sm:h-[60vh] md:h-[70vh] overflow-hidden">
        ...
        {/* Hero content — pushed down from top, safe on all screen sizes */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 -mt-6 sm:-mt-10 md:-mt-12 relative z-20">
        ...
        {/* Quick Stats — pulls up over hero */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
                ...
                {property.images.map((img, i) => (
                  <div 
                    ...
                    className={`overflow-hidden rounded-md group shadow-md ${
                      i === 0 ? 'sm:col-span-2 aspect-video sm:aspect-21/9' : 'aspect-video sm:aspect-16/10'
                    }`}
                  >
                    <img 
                      src={img} 
          ...
          {/* ── Right: Sidebar ── */}
          {/* On mobile: sits below all content. On lg+: sticky sidebar */}
