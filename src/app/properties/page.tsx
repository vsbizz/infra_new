 ...
 const [searchQuery, setSearchQuery] = useState("");
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-slate-900 mb-8 leading-[1.1] tracking-tight">
              ...
              <span className="text-brand-teal"> Global </span> <br />
              Healthcare Assets
            </h1>
      ...
      {/* Why Infra.Health Section */}
      <section className="bg-white py-24">
        <div className="mx-auto max-w-7xl px-8">
          <div className="grid lg:grid-cols-12 gap-16 items-start">
            {/* Sticky Header Section */}
            <div className="lg:col-span-5 lg:sticky lg:top-32">
              <h2 className="text-4xl font-extrabold leading-[1.1] tracking-tight text-slate-900 md:text-5xl lg:text-6xl mb-10">
                {solutionsData.value.title}
              </h2>
              <p className="text-xl leading-relaxed text-slate-600 mb-10 max-w-md">
            ...
            <div className="lg:col-span-7 grid md:grid-cols-2 gap-8">
              {solutionsData.value.points.map((item, idx) => (
                ...
                >
                  ...
                  {/* Content Section */}
                  <div className="p-8 border-b-4 border-transparent group-hover:border-teal-600 transition-all duration-500 min-h-55 flex flex-col">
                    <div className="text-slate-400 font-bold text-xs tracking-widest mb-4">
                      STRATEGIC PILLAR 0{idx + 1}
                    </div>
                    <h4 className="text-2xl font-bold text-slate-900 mb-4 group-hover:text-teal-600 transition-colors">
                      {item.title}
                    </h4>
